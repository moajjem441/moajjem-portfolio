      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass-card p-8 md:p-12 rounded-[40px] border border-white/5">
          ...
          <p className="text-on-surface-variant text-base md:text-lg leading-relaxed mb-8">
            A production-grade AI-powered EdTech platform with secure authentication,
            personalized course recommendations, Stripe payments, and intelligent course
            management.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            ...
            <div className="bg-surface-container p-6 rounded-2xl border border-outline-variant/30">
              ...
              <a
                href="https://skillhub-ivory.vercel.app"
                target="_blank"
                rel="noopener noreferrer"
                className="text-on-surface hover:text-primary transition-colors break-all text-sm"
              >
                skillhub-ivory.vercel.app
              </a>
            </div>
          </div>
          ...
          <div className="mb-8 p-6 rounded-2xl bg-surface-container/50 border border-outline-variant/20">
            ...
            <p className="text-on-surface-variant leading-relaxed">
              Stripe webhook integration with MongoDB transactions was complex.
              Ensuring real-time AI recommendations using Groq API without lag and
              managing role-based JWT authorization for 3 different dashboards
              required careful middleware architecture.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-primary-container/10 border border-primary/10">
            ...
            <p className="text-on-surface-variant leading-relaxed">
              Add live video conferencing for classes, build a collaborative
              filtering recommendation engine, and support multi-language
              subtitles for global users.
            </p>
          </div>
        </div>
      </div>
